...
const developerSchema = z.object({
  ...
  checkinTime: z.string().regex(/^([01]\d|2[0-3]):([0-5]\d)$/, "Format HH:MM").default("09:00"),
  checkoutTime: z.string().regex(/^([01]\d|2[0-3]):([0-5]\d)$/, "Format HH:MM").default("18:00"),
...
export default function Developers() {
  ...
  const onSubmit = (data: DeveloperFormValues) => {
    if (editingId) {
      updateDeveloper.mutate({ id: editingId, data }, {
        onSuccess: () => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage team members and schedules</p>
        </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-4">
                  <Button type="submit" disabled={createDeveloper.isPending || updateDeveloper.isPending}>
              ...
              {isLoading ? (
                ...
                <TableRow key={dev.id}>
                  ...
                  <TableCell>
                    ...
                    {dev.slackId && <div className="text-xs text-muted-foreground">Slack: {dev.slackId}</div>}
                  </TableCell>
